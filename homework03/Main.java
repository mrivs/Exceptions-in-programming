 ...
 * и показать пользователю сообщение, что он ввел меньше и больше данных, чем
 * требуется.
 * 
 ...
 * быть корректно обработано, пользователю выведено сообщение с информацией, что
 * именно неверно.
 * 
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" - Введите данные пользователя через пробел ( Фамилия Имя Отчество Номер ) \n - Для завершения работы приложения введите q:");
        while(!isExit) {

            try {
                Employee emp = Inputer.InputEmployee();
                MyWriter.addEmployee(emp);
            ...
            catch (MyWriterExeption e){
                System.out.println(e.getMessage());
                e.printStackTrace();
            }
            catch (Exception e) {
                System.out.print("Данные не добавлены: ");
                System.out.println(e.getMessage());
            }
        }
